 ...
 */
function little_cozy_site_logo ( $args = array(), $display = true ) {
	 ...
	 */
	$html = apply_filters( 'little_cozy_site_logo', $html, $args, $classname, $contents );
 ...
 */
function little_cozy_site_description( $display = true ) {
	 ...
	 */
	$html = apply_filters( 'little_cozy_site_description', $html, $description, $wrapper );
